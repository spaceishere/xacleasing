...
// Static data for machinery leasing
const staticPostData = {
  id: "machinery-leasing-static",
  title: { rendered: "МАШИН МЕХАНИЗМЫН ЛИЗИНГ" },
  content: {
    rendered: `
      <p>Эрхэм Та албан ёсны борлуулагч байгууллагуудаас уул уурхай, зам барилга, ачаа тээврийн үйлчилгээнд ашиглагдах тоног төхөөрөмж, техник, тусгай зориулалтын машин механизм авахаар төлөвлөж байгаа бол бид хамгийн таатай нөхцөлтэй шуурхай, хялбар Лизингийн үйлчилгээг санал болгож байна.</p>
  ...
  acf: {
    requirements: `
      <ul class="uk-list uk-list-bullet tavigdah_show">
        ...
        <li>Машин механизмыг ашиглах зориулалтыг тодорхой заасан байх.</li>
      </ul>
    `,
    individuals: `
    ...
    legal_entities: `
      <ul class="uk-list uk-list-bullet aan_show">
        ...
        <li>Машин механизм ашиглах үйл ажиллагааны товч танилцуулга.</li>
      </ul>
    `,
    interest_rate: { first_value: "1.6", second_value: "1.9", gap: "0.1", degree: "90" },
    period: { value: "10", degree: "120" },
    fee: "0.5",
    header_img: "/images/back.jpg",
    pre_payment: { first_value: "20", gap: "5", degree: "60" },
    img: "/images/back.jpg",
...
const MachineryLeasing = ({ mainMenu, stickyMenu }) => {
  ...
  const shareUrl = typeof window !== "undefined" ? `${window.location.origin}/machinery-leasing` : "https://xacleasing.mn/machinery-leasing";
...
export default MachineryLeasing;
